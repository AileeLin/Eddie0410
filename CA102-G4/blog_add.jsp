        ...
        <%@ page import="javax.sql.*" %>
            <%@ page import="javax.naming.*" %>
                ...
                <head>
                    ...
                    <!-- 設定網頁keywords -->
                    <meta name="keywords" content="TravleMaker,travlemaker,自助旅行,部落格,旅遊記" />
                    <!-- //設定網頁keywords -->
                ...
                <body>
                    <%
                       ...
                       ResultSet rs = stmt.executeQuery("SELECT TRAVLE_NAME FROM MYTRAVLE WHERE MEMID=1");
                    %>
                        <!-- banner -->
                                ...
                                <div class="container">
                                    <div class="top-banner-left">
                                        <ul>
                                            ...
                                            <li><a href="mailto:TravleMaker@gmail.com"><i class="fa fa-envelope" aria-hidden="true"></i> TravleMaker@gmail.com</a></li>
                                        </ul>
                                    </div>
                                ...
                                <div class="ItineraryListModalContent">
                                    <div class="ui selection dropdown">
                                        ...
                                        <% if(rs.next()){ %>
                                            ...
                                            <% }else{ %>
                                                <div class="default text">尚無行程可選擇</div>
                                                <%  }%>
                                                    <!-- //資料庫撈行程名稱 -->
                                    </div>
                                </div>
