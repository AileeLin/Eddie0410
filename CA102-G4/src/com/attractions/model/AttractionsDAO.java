...
public class AttractionsDAO implements AttractionsDAO_interface {
...
//				attVO.setAtt_picture(rs.getBytes("ATT_PICTURE"));
	...
	public List<AttractionsVO> getAll(Map<String, String[]> map) {
		...
		try {
			con = ds.getConnection();
			String finalSQL = "select ATT_NO,ATT_NAME,ATT_LAT,ATT_LON,COUNTRY,ADMINISTRATIVE_AREA,ATT_INFORMATION,ATT_ADDRESS,ATT_STATUS from ATTRACTIONS "
