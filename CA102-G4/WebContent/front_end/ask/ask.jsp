...
<body>
	...
	<div class="container">
		...
		<hr>
		<form name = 'form' action = '<%=request.getContextPath()%>/question.do' method='post'>
            ...
            <input type="checkbox" value="${qa_listVO.list_id}" name="list_id">${qa_listVO.list_name}
            </c:forEach> 
            <br>
