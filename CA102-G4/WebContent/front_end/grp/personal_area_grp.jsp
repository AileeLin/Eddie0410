          ...
          <div class="tab-content" style="float:left;width:100%">
            ...
            <div id="home" class="container tab-pane active">
               ...
               <ul class="nav nav-tabs">
				  <li role="presentation" class="active"><a href="<%=request.getContextPath()%>/front_end/grp/personal_area_grp.jsp">我的揪團</a></li>
				  <li role="presentation"><a href="<%=request.getContextPath()%>/front_end/grp/personal_grp_join.jsp?grp_Id=">我參加的揪團</a></li>
			  </ul>
                            ...
                            <c:forEach var="GrpVO" items="${grpList}">
		                      ...
		                      <div class="item col-12">
		                        <div class="ui small image ">
		                          <a href="<%=request.getContextPath()%>/front_end/grp/personal_grp_review.jsp?grp_Id=${GrpVO.grp_Id}">
                               ...
                               <a href="<%=request.getContextPath()%>/front_end/grp/grp_update.jsp?grp_Id=${GrpVO.grp_Id}" style="margin: auto 0;">
                               <button type="submit" class="btn btn-warning" style="margin:auto 0;">修改</button>
                               </a>
                              <form action="<%=request.getContextPath()%>/grp.do" method="post"  style="margin:auto 0;margin-left: 30px;margin-right: 30px;" onsubmit="return confirm('確定要刪除?')">
