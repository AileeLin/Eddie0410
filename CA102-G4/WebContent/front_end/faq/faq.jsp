...
<%
	...
	List<FaqVO> faqVO =faqSvc.getAll();	
	pageContext.setAttribute("faqVO", faqVO);
%>
<%
	//取得購物車商品數量
...
<head>
    ...
    <link href="<%=request.getContextPath()%>/front_end/css/faq/faq.css" rel="stylesheet" type="text/css" media="all">
    <!-- //css -->
    <!-- font-awesome icons -->
...
<body>
    ...
    <section class="faq">
        ...
        <div class="faq-items">
       <c:forEach var="faqVO" items="${faqVO}" >
            <ul id="basics" class="faq-group">
                <li>
                    <a class="trigger" href="#0"><c:out value="${faqVO.faq_qa}" /></a>
                    <div class="faq-content">
                        <p><c:out value="${faqVO.faq_content}" />	</p>
                    </div>
                </li>
