    ...
    <div class="ui container" id="container">
        ...
        <!-- Menu -->
	  	<div class="ui tabular menu">
            ...
            <a class='item ${(param.action=="searchMember") || (param.action == null)?"active":""}' href="<%=request.getContextPath()%>/blog.do?action=searchMember&keyword=${param.keyword}">
                會員
            </a>
        ...
        <!-- 搜尋時間 -->
        <div class="time">
        	<div class="load"><span id="resultCount">共找到 ${memList.size()} 個結果</span>，花費 <span id="time"> 秒</span></div>
        </div>
        <!-- //搜尋時間 -->
        <!-- 下面搜尋結果 -->
        <div class="row">
			...
			<c:if test="${empty memList}">
				<div class="ui left aligned search_results empty" style="text-align:center;height:300px;border:1px solid lightgray">
					<p style="color:darkgray;height:100%;line-height:300px;font-size:40px">沒有相關關鍵字的會員!!</p>
				</div>
			</c:if>
        </div>
        <!-- //下面搜尋結果 -->
