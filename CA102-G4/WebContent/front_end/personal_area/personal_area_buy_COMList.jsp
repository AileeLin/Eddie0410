...
<head>
   ...
   <style>
	...
	<c:if test="${memberVO != null}">
		<script>
			function ratingSellOrdMessage(buyer_id,seller_id,order_id){
				
				var jsonObj = {
					"title"		:"訂單評價",
				  	"sender"	: buyer_id,
				 	"receiver"	: seller_id,
				 	"message"	:"您的訂單編號:"+order_id+"，買家已經給您評價"
				};
    ...
    <div class="modal-dialog modal-lg">
     ...
     <!-- 已完成 評價  Modal content-->
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <input type="hidden" name="ratingSellerId" id="ratingSellerId" value=""/>
...
function ratingOrder(ordId,memName,memId){
	...
	$(".modal-footer #ratingSellerId").val( memId );
...
function ratingById(){
	...
	var sellerId = $(".modal-footer #ratingSellerId").val();
	...
	$.ajax({
		...
		success:function(data){
			...
			if(data=='not null'){
				...
				ratingSellOrdMessage("${memId}",seller_id,ordId);
			}
		}
	})
