    ...
    <div class="ui container">
        ...
        <div class="mem_ind_content">
          ...
          <ul class="nav nav-tabs" role="tablist">
            ...
            <li class="nav-item">
              <a href="<%=request.getContextPath()%>/front_end/personal_area/personal_area_blog.jsp">
    	...
    	if(webSocketState != 3){
			...
			if($("#"+openChatRoomID+"").length === 0){
				...
				if(right > 1220 || right <= 0){
					alert("超過邊界了openChatRoom");
					right = 350;
				}
				alert("openChatRoom時，長度:"+right);
