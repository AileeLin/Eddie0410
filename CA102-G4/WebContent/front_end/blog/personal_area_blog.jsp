...
<body>
    ...
    <div class="ui container">
        ...
        <!-- //Menu -->
			...
			%>
                <a class="ui fluid card" href="<%=request.getContextPath()%>/blog.do?action=article&blogID=${blogVO.blog_id}">
                    <div class="image">
                    ...
                    <div class="extra content edit_Del">
                        ...
                        <form name="update" class="update form" METHOD="POST" ACTION="<%=request.getContextPath()%>/blog.do?action=update&blog_id=${blogVO.blog_id}">
                        ...
                        <form name="delete" class="delete form" METHOD="POST" ACTION="<%=request.getContextPath()%>/blog.do?action=hide&blog_id=${blogVO.blog_id}">
