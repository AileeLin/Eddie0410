...
// 	List<blogVO> list = blogSvc.findByMemId(blogVO.getMem_id());
	List<blogVO> list = blogSvc.findByMemId("M000009");
...
<body>
            ...
            <div class="container">
                ...
                <div class="top-banner-right">
                    <ul>
						...
						<li><a class="top_banner" href="<%=request.getContextPath()%>/front_end/personal_area_home.html"><i
								class="fa fa-envelope" aria-hidden="true"></i></a></li></ul>
                </div>
    ...
    <div class="ui container">
        ...
        <div class="mem_ind_topbar">
            ...
            <div class="mem_ind_info">
                <div class="mem_ind_img">
                    <img src="<%=request.getContextPath()%>/front_end/images/all/p7.jpg">
                </div>
        ...
        <div class="mem_ind_content">
			...
			%>
                <a class="ui fluid card" href="<%=request.getContextPath()%>/front_end/blog/blog_article.jsp?blogID=${blogVO.blog_id}">
                    <div class="image">
                    ...
                    <div class="extra content edit_Del">
                        <div class="right floated author nowrap">
                            <div class="btn mx-2 editBlog" onclick="location.href='<%=request.getContextPath()%>/blog.do?action=update&blog_id=${blogVO.blog_id}'">
                                <i class="fas fa-edit"></i> 修改
                            </div>
                            <div class="btn mx-2 delBlog" onclick="location.href='<%=request.getContextPath()%>/blog.do?action=hide&blog_id=${blogVO.blog_id}'">
                            ...
                            <div class="ui middle aligned selection list" style="height:89%;overflow:auto">
                                ...
                                <div class="item">
                                    ...
                                    <label for="fri01" style="width:80%">
                                        <img class="ui avatar image" src="../images/all/p1.jpg">
                                ...
                                <div class="item">
                                    ...
                                    <label for="fri02" style="width:80%">
                                        <img class="ui avatar image" src="../images/all/p2.jpg">
                                ...
                                <div class="item">
                                    ...
                                    <label for="fri03" style="width:80%">
                                        <img class="ui avatar image" src="../images/all/p3.png">
                                ...
                                <div class="item">
                                    ...
                                    <label for="fri04" style="width:80%">
                                        <img class="ui avatar image" src="../images/all/p4.png">
                                ...
                                <div class="item">
                                    ...
                                    <label for="fri05" style="width:80%">
                                        <img class="ui avatar image" src="../images/all/p5.jpg">
                                ...
                                <div class="item">
                                    ...
                                    <label for="fri06" style="width:80%">
                                        <img class="ui avatar image" src="../images/all/p6.png">
