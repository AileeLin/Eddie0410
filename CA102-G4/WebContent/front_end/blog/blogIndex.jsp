...
<body>
	...
	<div class="ui container">
		...
		<!-- //我是隔板 -->
		<!-- Menu -->
		<FORM METHOD="POST" ACTION="<%=request.getContextPath()%>/blog.do">
			<div class="ui tabular menu">
				<a class="item active itemRight" href="<%=request.getContextPath()%>/blog.do?orderby=recent"> 最新分享 </a> 
				<a class="item itemRight" href="<%=request.getContextPath()%>/blog.do?orderby=popular"> 最多瀏覽 </a>
				<!-- 搜尋BAR -->
				<div class="ui massive right action left icon input">
					<i class="search icon"></i> 
					<input type="text" placeholder="請輸入關鍵字..." name="keyword"> 
					<input type="hidden" name="action" value="keyword">
					<input type="hidden" name="orderby" value="<%= (orderby==null)? "recent" : orderby %>">
