...
<%
    ...
    List<Qa_listVO> list = qa_listSvc.getAll();
    ...
    <body>
       ...
       <div class="container-fluid">
        ...
        <c:choose>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">標籤管理 > 問答區</h1>
		...
		<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/qa_list.do" name="form1">
		
				
					標籤名稱:
					<input type="TEXT" name="list_name" class="form-control f1" value="${qa_listVO.list_name}">
					<br>
		...
		<c:forEach var="qa_listVO" items="${list}" >		
						<tr>
							<td>${qa_listVO.list_name}</td>
							<td>
			  				<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/qa_list.do" style="margin-bottom: 0px;">
			     				<input type="submit" value="刪除" class="btn btn-danger">
			     				<input type="hidden" name="list_id"  value="${qa_listVO.list_id}">
