    ...
    <body>
       ...
       <div class="container-fluid">
        ...
        <c:choose>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">關於我們管理 > FAQ</h1>
        ...
        <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/faq.do" name="form1">
            ...
            FAQ標題:
                        ...
                        <input type="TEXT" name="faq_qa"  class="form-control f1" value="${faq.faq_qa}">
                  
                    <br>
            FAQ內容:
                    
                        <textarea  name="faq_content" rows="3" cols="50" class="form-control f1" ${faq.faq_content}></textarea>
        ...
        <c:forEach var="faqVO" items="${list}" >       
                        <tr>
                            ...
                            <td>
                            <FORM METHOD="post" ACTION="/CA102G4/faq.do" style="margin-bottom: 0px;">
