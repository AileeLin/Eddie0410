...
<%
    ...
    List<About_usVO> list = about_usSvc.getAll();
    ...
    <body>
       ...
       <div class="container-fluid">
        ...
        <h1 class="page-header">關於我們管理 > 關於我們</h1>
			...
			<c:forEach var="about_usVO" items="${list}" >
			 ...
			 <table class="table">
				...
				<tbody>
				   	<tr>
				     	<td>${about_usVO.about_content}</td>
				   </tr>
				</tbody>
			 </table> 

		<br>
			<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/about_us.do" style="margin-bottom: 0px;">
                  <input type="submit" value="修改" class="btn btn-danger">
                  <input type="hidden" name="about_us_id"  value="${about_usVO.about_us_id}">
