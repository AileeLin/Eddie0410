...
<%
About_usVO about_usVO = (About_usVO) request.getAttribute("about_usVO");
    ...
    <head>
       ...
       <div class="container-fluid">
        ...
        <c:choose>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">關於我們管理 > 關於我們</h1>
		...
		<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/about_us.do" name="form1">		
			
			<textarea  name="about_content" style="width:1140px;height:120px" class="form-control f1">${about_usVO.about_content}</textarea>
			<br>
			<input type="hidden" name="about_us_id" value="<%=about_usVO.getAbout_us_id()%>">
             <input type="hidden" name="action"  value="update">
			<input type="submit" value="完成" class="btn btn-danger">
