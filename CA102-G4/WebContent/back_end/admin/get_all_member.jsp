...
if(login_state_backEnd!=true){
 session.setAttribute("location_Backend","/CA102G4/back_end/admin/get_all_member.jsp");
				...
				<div class="btn-toolbar mb-2 mb-md-0">
					<div role="tabpanel">
						...
						<ul class="nav nav-tabs" role="tablist">
							...
							<li onclick="location.href = '<%=request.getContextPath()%>/back_end/admin/manager_member.jsp'" role="presentation"><a aria-controls="tab1"
									...
									<tbody>
										<c:forEach var="memberVO" items="${list}">
											<tr>
												...
												<td>
													<form action="/CA102G4/front_end/member/member.do"
														method="get">
