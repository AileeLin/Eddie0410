...
<%
	...
	if(login_state_backEnd!=true){
	 session.setAttribute("location_Backend","/CA102G4/back_end/admin/update_admin.jsp");
				...
				<div class="btn-toolbar mb-2 mb-md-0">
					<div role="tabpanel">
						...
						<ul class="nav nav-tabs" role="tablist">
							...
							<li onclick="location.href = '<%=request.getContextPath()%>/back_end/admin/get_all_admin.jsp'" role="presentation"><a href="#tab2" aria-controls="tab2" 
						...
						<div class="tab-content active">
							...
							<form METHOD="post" action="<%=request.getContextPath()+"/admin.do"%>" 
										...
										data-animate-effect="fadeIn" id="tab4">
										
<!-- 										<div class="form-group"> -->
<!-- 											<label for="name" class="sr-only">Name</label>  -->
<%-- 											<input type="text" name="admin_Name"  value="${adminVO.admin_Name}" class="form-control"  --%>
...
<!-- 										</div> -->
											...
											<div class="form-group">
												<label for="password" class="sr-only">type-Password</label> 
												<input type="password" name="admin_Password" value="" class="form-control" 
													placeholder="password" autocomplete="off">
											</div>
											...
											<div class="form-group">
												...
												<input type="text" name="admin_Mail" value="${adminVO.admin_Mail}" class="form-control"
													placeholder="Email" autocomplete="off">
											</div>
											<div class="form-group">
												<label for="Phone" class="sr-only">Phone</label> 
												<input type="text" name="admin_Phone" value="${adminVO.admin_Phone}" class="form-control"
										...
										<div class="form-group">
											...
											<input type="hidden" name="action" value="update_Admin" class="btn btn-primary"> 
