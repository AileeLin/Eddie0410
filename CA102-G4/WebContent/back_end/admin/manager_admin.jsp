...
<%
	...
	if(login_state_backEnd!=true){
	 session.setAttribute("location","/CA102G4/back_end/admin/manager_admin.jsp");
							...
							<form method="post" action="<%=request.getContextPath()+"/admin.do"%>">
								...
								<div class="input-group">
									<input type="text" class="form-control" name="admin_Name"
										placeholder="搜尋員工 ..." style="height: 46px" />
									<div class="input-group-btn">
										<button class="btn btn-danger btn-lg" type="submit">
											<span class="fas fa-search"></span>
										</button>
										<input type="hidden" name="action" value="getAll_Keyword">
									</div>
								</div>
								<jsp:include page="get_one_admin.jsp" flush="true" />
							</form>
						</div>
